...
, function(t, e, i) {
    ...
    var o, r = document.getElementById("tp__canvas"), a = r.getContext("2d");
    ...
    var l = {}
      ...
      , s = function() {
        ...
        (i = [{
            ...
            value: function() {
                a.beginPath(),
                this.particleSize > 0 && (a.arc(this.pointX, this.pointY, this.particleSize, 0, 2 * Math.PI),
            ...
            key: "update",
            value: function() {
                (this.pointX > r.width - this.halfTextWidth || this.pointX < this.halfTextWidth) && (this.moveX = -this.moveX),
                (this.pointY > r.height || this.pointY < this.textSize) && (this.moveY = -this.moveY),
        ...
        !function() {
            for (var t, e = r.width * r.height, i = 0; i < o.length; i++)
                for (var n = i; n < o.length; n++) {
                    ...
                    l < e && (t = 1 - l / 4e4,
                    a.strokeStyle = "rgba(255,255,255, ".concat(t, ")"),
                    a.lineWidth = 1,
                    a.beginPath(),
    ...
    l.accelerate = function(t) {
        ...
        h.particleColor = t.particleColor || "#00adef",
        h.particleSize = t.particleSize || 0,
        h.textColor = t.textColor || "#dddddd",
        h.textList = (t.textList || "Freedom Online, Roohweb, #1 ISP in Mirpur, Gaming Boss, Low Latency , BDIX Service, Biggest FTP Server , Live TV Server , Freedom Online, Instant FTP Upload , Several Upstream provider, FTTH USER PACKAGE , GAMING USER PACKAGE, DEDICATED USER PACKAGE , Online Payment , Bkash Payment , Rocket Payment , 24x7 online Support").split(", "),
