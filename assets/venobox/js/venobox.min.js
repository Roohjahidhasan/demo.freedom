...
!function(e) {
    function a() {
        e.ajax({
            ...
            f.html('<div class="vbox-inline">' + e + "</div>"),
            c()
        }).fail(function() {
            f.html('<div class="vbox-inline"><p>Error retrieving contents, please retry</div>'),
            r()
        })
    }
    function o() {
        f.html('<iframe class="venoframe" src="' + m + '"></iframe>'),
        r()
    }
    function t(e, a) {
        ...
        if ("vimeo" == a) {
            ...
            t = i(m);
        f.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen frameborder="0" src="' + o + t + s + '"></iframe>'),
        r()
    }
    function i(e) {
        var a = "";
        return e = e.replace(/(>|<)/gi, "").split(/(vi\/|v=|\/v\/|youtu\.be\/|\/embed\/)/),
        void 0 !== e[2] ? (a = e[2].split(/[^0-9a-z_\-]/i),
        a = a[0]) : a = e,
        a
    }
    function s() {
        f.html('<div class="vbox-inline">' + e(m).html() + "</div>"),
        r()
    }
    function c() {
        images = e(".vbox-content").find("img"),
        images.length ? images.each(function() {
    ...
    function r() {
        b.html(q),
        f.find(">:first-child").addClass("figlio"),
        e(".figlio").css("width", g).css("height", x).css("padding", u).css("background", d),
        n(Q, H),
        f.animate({
            opacity: "1"
        }, "slow", I(f, v, b))
    ...
    function n() {
        ...
        H > Q + 30 ? (_ = (H - Q) / 2,
        f.css("margin-top", _),
        f.css("margin-bottom", _)) : (f.css("margin-top", "30px"),
    ...
    e.fn.extend({
        venobox: function(i) {
            ...
            return this.each(function() {
                var i = e(this);
                return i.data("venobox") ? !0 : (i.addClass("vbox-item"),
                ...
                void i.on("click", function(r) {
                    function _() {
                        ...
                        B = i.data("numeratio"),
                        y = i.data("infinigall"),
                        w = e('.vbox-item[data-gall="' + P + '"]'),
                        w.length > 1 && B === !0 ? (v.html(w.index(i) + 1 + " / " + w.length),
                        v.show()) : v.hide(),
                        D = w.eq(w.index(i) + 1),
                        E = w.eq(w.index(i) - 1),
                        "" !== q ? b.show() : b.hide(),
                        ...
                        A = !0,
                        D.length < 1 && (D = w.eq(0)),
                        w.index(i) < 1 && (E = w.eq(w.index(w.length)))) : (D.length > 0 ? (e(".vbox-next").css("display", "block"),
                        T = !0) : (e(".vbox-next").css("display", "none"),
                        T = !1),
                        w.index(i) > 0 ? (e(".vbox-prev").css("display", "block"),
                        A = !0) : (e(".vbox-prev").css("display", "none"),
                        A = !1))
                    }
                    function H(e) {
                        27 === e.keyCode && Q()
                    ...
                    function Q() {
                        ...
                        (void 0 == a || a) && (e("body").removeClass("vbox-open"),
                    ...
                    if (void 0 == I || I) {
                        switch (j = i.data("overlay") || i.data("overlaycolor"),
                        g = i.data("framewidth"),
                        ...
                        z.animate({
                            ...
                            "iframe" == i.data("vbtype") ? o() : "inline" == i.data("vbtype") ? s() : "ajax" == i.data("vbtype") ? a() : "vimeo" == i.data("vbtype") ? t(l, "vimeo") : "youtube" == i.data("vbtype") ? t(l, "youtube") : (f.html('<img src="' + m + '">'),
                            c())
                        });
                        var J = {
                            prev: function() {
                                ...
                                l = E.data("autoplay"),
                                q = E.attr(E.data("titleattr")) || "",
                                f.animate({
                                    opacity: 0
                                }, 500, function() {
                                    z.css("background", j),
                                    "iframe" == E.data("vbtype") ? o() : "inline" == E.data("vbtype") ? s() : "ajax" == E.data("vbtype") ? a() : "youtube" == E.data("vbtype") ? t(l, "youtube") : "vimeo" == E.data("vbtype") ? t(l, "vimeo") : (f.html('<img src="' + m + '">'),
                                    c()),
                                    i = E,
                                    _(),
                                    C = !1
                            ...
                            next: function() {
                                ...
                                l = D.data("autoplay"),
                                q = D.attr(D.data("titleattr")) || "",
                                f.animate({
                                    opacity: 0
                                }, 500, function() {
                                    z.css("background", j),
                                    "iframe" == D.data("vbtype") ? o() : "inline" == D.data("vbtype") ? s() : "ajax" == D.data("vbtype") ? a() : "youtube" == D.data("vbtype") ? t(l, "youtube") : "vimeo" == D.data("vbtype") ? t(l, "vimeo") : (f.html('<img src="' + m + '">'),
                                    c()),
                                    i = D,
                                    _(),
                                    C = !1
                        ...
                        e("body").keydown(function(e) {
                            37 == e.keyCode && 1 == A && J.prev(),
                            39 == e.keyCode && 1 == T && J.next()
                        }),
                        ...
                        var K = ".vbox-overlay";
                        return n.overlayClose || (K = ".vbox-close"),
